...
def quadrantic_approx(f, x1, delta_x, accuracy1, accuracy2):
    ...
    while True:
        ...
        if func_razn and arf_razn:
            return f"рассичитанное значение x: {x_per}, рассчитанное значение производной функции в точке: {float(fxp)}, Количество итераций: {i}"
...
print("Ответ:", quadrantic_approx(func, np.pi/8, 0.5, 0.03, 0.0001))